...
#	undef  MU0_HAVE_XLOCALE
#	define MU0_HAVE_XLOCALE 0
...
#		define __mu0_strcmp__(lhs, rhs)             strcmp(lhs, rhs)
		typedef _locale_t __mu0_xlocale_t__;
...
#		define __mu0_strcmp__(lhs, rhs)             strcmp(lhs, rhs)
		typedef locale_t __mu0_xlocale_t__;
#	else
		typedef void * __mu0_xlocale_t__;
#		define __mu0_strcmp__(lhs, rhs)             strcmp(lhs, rhs)
#	endif
...
__mu0_static_inline__
__mu0_xlocale_t__ __mu0_xlocale_use__(__mu0_xlocale_t__ loc)
{
#	if   MU0_HAVE_WINDOWS && !MU0_HAVE_MINGW
